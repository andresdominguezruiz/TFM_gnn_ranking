...
from layer import CNN_Layer, GNN_Layer, Transformer_Layer
...
class Transformer_Close(nn.Module):
    def __init__(self, ninput, nhid, dropout):
        ...
        self.gc2 = Transformer_Layer(nhid,nhid)
        self.gc3 = Transformer_Layer(nhid,nhid)
        self.gc4 = Transformer_Layer(nhid,nhid)
        self.gc5 = Transformer_Layer(nhid,nhid)
        self.gc6 = Transformer_Layer(nhid,nhid)
        self.gc7 = Transformer_Layer(nhid,nhid)
