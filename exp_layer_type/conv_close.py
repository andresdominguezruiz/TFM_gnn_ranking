...
class CNN_Close(nn.Module):
    def __init__(self, ninput, nhid, dropout):
        ...
        self.gc2 = CNN_Layer(nhid,nhid)
        self.gc3 = CNN_Layer(nhid,nhid)
        self.gc4 = CNN_Layer(nhid,nhid)
        self.gc5 = CNN_Layer(nhid,nhid)
        self.gc6 = CNN_Layer(nhid,nhid)
        self.gc7 = CNN_Layer(nhid,nhid)
